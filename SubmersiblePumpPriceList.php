<?php
$koneksi = mysqli_connect('localhost', 'root', '', 'pricesp');
...
<html lang="en">
  <head>
    ...
    <title>Submersible Pump PriceList</title>
  </head>
  <body>
            ...
            <div class="col-md-4">
              <div class="card-empl">
                <div class="rectangle-icon-1 position-relative mx-auto">
                  <img src="Assest/Image/Water Pump 3.png" alt="" class="position-absolute top-50 start-50 translate-middle"> 
                </div>
